$(document).ready(function () {
    ...
    VanillaTilt.init(document.querySelector(".images img"), {
        max: 5,
        speed: 400
    });
    VanillaTilt.init(document.querySelectorAll(".images img"));
    $(".menuproduct__container").click(function (e) {
        e.preventDefault();
